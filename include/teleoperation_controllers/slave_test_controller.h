#ifndef SLAVE_TEST_CONTROLLER_H
#define SLAVE_TEST_CONTROLLER_H
...
{
	class slave_test_controller: public controller_interface::KinematicChainControllerBase<hardware_interface::PositionJointInterface>
	{
	public:
		slave_test_controller();
		~slave_test_controller();
